...
A full-stack Flutter e-commerce application where **AI can handle the shopping process through natural conversation**.
...
* **Stripe & SafePay** — Test-mode payments
...
├── admin_panel_2.jpeg
├── auth_image.jpeg
├── category_screen.jpeg
├── chat_bot.jpeg
├── favourite_screen.jpeg
├── home_1.jpeg
├── home_2.jpeg
├── order_details.jpeg
├── settings.jpeg
└── WhatsApp Image 2026-08-12 at 6.38.23 PM.jpeg
...
**LinkedIn:** [View the project on LinkedIn](https://lnkd.in/p/dWRq32e8)

---

Built with Flutter, Django REST Framework, Firebase, and AI-powered shopping.
